 ...
 * generated in the dsmsclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _Invoke_QNAME = new QName("http://components.dsms/", "invoke");
    private final static QName _InvokeResponse_QNAME = new QName("http://components.dsms/", "invokeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dsmsclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://components.dsms/", name = "invoke")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://components.dsms/", name = "invokeResponse")
